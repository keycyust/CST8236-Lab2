...
Cube::Cube(GLuint textureID) : _horizontalAngle(0), _verticalAngle(0), _textureID(textureID), direction(1), isRotating(false)
{
	_textureOffset = 0.0f;
}

void Cube::Update(float dt, int direction, bool isRotating)
{
